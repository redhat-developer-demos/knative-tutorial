...
=== Build Containers
include::./_buildcontainers.adoc[leveloffset=+1,tag=greeter]
...
=== Invoke Service
include::./_invokeservice.adoc[leveloffset=+1,tag=*]
...
==== service 
include::_knative-objects.adoc[leveloffset=+1,tag=knative-services]

[#basics-show-knative-configs]
==== configuration
include::_knative-objects.adoc[leveloffset=+1,tag=knative-configs]

[#basics-show-knative-routes]
==== routes
include::_knative-objects.adoc[leveloffset=+1,tag=knative-routes]
...
==== revisions
include::_knative-objects.adoc[leveloffset=+1,tag=knative-revisions]
...
As you noticed that the Knative services always routes the traffic to the **latest** revision of the service deployment, thats because of the **runLatest** attribute in <<service-rev2,service resource file>>.
...
<<invoke-service,Invoking Service>> will now show an output like **Hi greeter => greeter-00001-deployment-5d696cc6c8-m65s5: 3**.

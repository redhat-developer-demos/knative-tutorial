...
[source,bash,subs="+macros,+attributes"]
----
kubectl subscription -n {tutorial-namespace} list
----
--
{kubernetes-cli}::
+
...
[source,bash,subs="+macros,+attributes"]
----
kn service delete -n {tutorial-namespace} delete eventing-helloa
kn subscription delete eventinghelloa-sub --namespace {tutorial-namespace}
kn service delete -n {tutorial-namespace} delete eventing-helloab

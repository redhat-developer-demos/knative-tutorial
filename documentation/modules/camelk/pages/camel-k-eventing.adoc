...
The `Kamelet` allows you use a Camel K integration as part of the Knative Eventing architecture. Simply speaking, you can make the Camel K integration act as a https://knative.dev/docs/eventing/sources/[Knative Event Source] and  send the Camel exchanges (OUT) through a Knative Event Sink.
...
- kn-source-kamelet : /usr/local/bin/kn-source-kamelet
----
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
kn source kamelet list  -n {tutorial-namespace}
----
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
kubectl create -f advanced/camel-k/get-started/timed-greeter-binding.yaml --edit -o yaml -n {tutorial-namespace}
----

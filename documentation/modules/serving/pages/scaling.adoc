...
with this current setting of **concurrencyTarget=10** and **utilization=0.7**, when you receive 140 requests(*actualConcurrency*) then Knative will scale upto *20* pods i.e. 140/10/0.7.

...
[source,bash,subs="+macros,attributes"]
----
- http://v1-greeter.knativetutorial.example.com #<1>
- http://v2-greeter.knativetutorial.example.com #<2>
- http://latest-greeter.knativetutorial.example.com #<3>
----

<1> the sub route for the traffic tag `v1
<2> the sub route for the traffic tag `v2`
...
greeter-v1-deployment-7ff594cc7b-d9h6l      2/2     Running       0          9s
----

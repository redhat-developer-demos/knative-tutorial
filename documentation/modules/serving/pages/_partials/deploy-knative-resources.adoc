...
[source,bash,subs="+macros,+attributes"]
----
kn service update greteer --tag="greeter-v1=v1"
kn service update greteer --tag="greeter-v2=v2"
kn service update greteer --tag="@latest=latest"
kn service update greteer \
  --traffic="v1=100" \
  --traffic="v2=0"  \
  --traffic="latest=0"
----

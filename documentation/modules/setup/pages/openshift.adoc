...
For more information on OpenShift Servertless, consult the https://docs.openshift.com/container-platform/4.6/serverless/admin_guide/installing-openshift-serverless.html#installing-openshift-serverless[OpenShift^] documentation.

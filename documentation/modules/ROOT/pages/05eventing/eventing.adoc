...
You have completed the xref:ROOT:04build/build.adoc[Build] or xref:ROOT:04build/build-templates.adoc[Build Templates], as you will be using the container image `event-greeter:0.0.1` or `event-greeter:0.0.2`  in this chapter.

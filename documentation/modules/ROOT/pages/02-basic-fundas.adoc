...
:service-env-yaml: service-env.remote.yaml
:service-pinned-yaml: service-pinned.remote.yaml
endif::[]
ifndef::workshop[]
:greeter-container-image: dev.local/rhdevelopers/greeter:0.0.1 #<2>
:service-yaml: service.yaml
:service-env-yaml: service-env.yaml
:service-pinned-yaml: service-pinned-yaml
endif::[]
...
----
copyToClipboard::rev1-basics-run-oc-svc-apply[]
...
.link:{github-repo}/{basics-repo}/knative/{service-pinned-yaml}[{service-pinned-yaml}]
[source,yaml,linenums,subs="+macros,+attributes"]
----
apiVersion: serving.knative.dev/v1alpha1
kind: Service

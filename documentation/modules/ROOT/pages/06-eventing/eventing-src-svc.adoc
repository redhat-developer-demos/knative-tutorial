...
ifndef::workshop[]
[#eventing-run-event-src-svc]
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -n {tutorial-namespace} -f link:{github-repo}/{eventing-repo}/knative/event-source-svc.yaml[event-source-svc.yaml]
----
copyToClipboard::eventing-run-event-src-svc[]

**(OR)**
endif::[]

[#eventing-run-oc-event-src-svc]
[source,bash,subs="+macros,+attributes"]
----
oc apply -n {tutorial-namespace} -f link:{github-repo}/{eventing-repo}/knative/event-source-svc.yaml[event-source-svc.yaml] 
----
copyToClipboard::eventing-run-oc-event-src-svc[]
...
----
copyToClipboard::eventing-run-gen-sink-service[]
...
ifndef::workshop[]
[#run-deploy-sink-service]
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -n {tutorial-namespace} -f service.yaml 
----
copyToClipboard::run-deploy-sink-service[]

**(OR)**
endif::[]

[#run-oc-deploy-sink-service]
[source,bash,subs="+macros,+attributes"]
----
oc apply -n {tutorial-namespace} -f service.yaml 
----
copyToClipboard::run-oc-deploy-sink-service[]

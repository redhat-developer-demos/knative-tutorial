...
ifdef::workshop[]
:greeter-container-image: quay.io/rhdevelopers/prime-generator:v27-quarkus
:service-yaml: service.remote.yaml
:service-10-yaml: service-10.remote.yaml
:service-min-scale-yaml: service-min-scale.remote.yaml
endif::[]
ifndef::workshop[]
:greeter-container-image: dev.local/rhdevelopers/greeter:0.0.1 #<2>
:service-yaml: service.yaml
:service-10-yaml: service-10.yaml
:service-min-scale-yaml: service-min-scale.yaml
endif::[]
...
=== Deploy service 
ifndef::workshop[]
[#scaling-run-autoscale-10]
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -n {tutorial-namespace} -f link:{github-repo}/{scaling-repo}/knative/{service-10-yaml}[{service-10-yaml}]
----
copyToClipboard::scaling-run-autoscale-10[]

**(OR)**
endif::[]

[#scaling-run-oc-autoscale-10]
[source,bash,subs="+macros,+attributes"]
----
oc apply -n {tutorial-namespace} -f link:{github-repo}/{scaling-repo}/knative/{service-10-yaml}[{service-10-yaml}]
----
copyToClipboard::scaling-run-oc-autoscale-10[]
...
:k8s-env: minikube
:doc-sec: auto-scale
include::partial$watch-scaling-pods.adoc[tag=cmd]
...
siege -r 1 -c 50 -t 30S \
  "http://pass:[${SVC_URL}]/?sleep=3&upto=10000&memload=100"
----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -n {tutorial-namespace} -f link:{github-repo}/{scaling-repo}/knative/{service-min-scale-yaml}[{service-min-scale-yaml}]
----
copyToClipboard::scaling-run-min-scale[]

**(OR)**
endif::[]

[#scaling-run-oc-min-scale]
[source,bash,subs="+macros,+attributes"]
----
oc apply -n {tutorial-namespace} -f link:{github-repo}/{scaling-repo}/knative/{service-min-scale-yaml}[{service-min-scale-yaml}]
----
copyToClipboard::scaling-run-oc-min-scale[]
